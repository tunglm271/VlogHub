...
class ProfileInfor(models.Model):
...
def create_infor(sender, instance,created, **kwargs):
    if created:
        user_infor = ProfileInfor(profile=instance.profile)
        user_infor.save()
post_save.connect(create_infor,sender = User)      
